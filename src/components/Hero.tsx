        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
          ...
          <div className="responsive-spacing fade-in order-2 lg:order-1">
            ...
            <div className="responsive-flex">
              <button onClick={handleWhatsAppClick} className="lp-button-primary flex items-center justify-center space-x-2 group flex-1 sm:flex-none mobile-button">
                <span>Solicitar Orçamento</span>
                <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 md:h-5 md:w-5 transition-transform group-hover:translate-x-1" />
              </button>
              
              <button onClick={() => scrollToSection('sobre')} className="lp-button-secondary flex-1 sm:flex-none mobile-button">
                Conhecer Mais
              </button>
            </div>
